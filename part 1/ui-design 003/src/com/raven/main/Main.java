...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        ...
        panelPricing.addItem(new Model_Data(false, "Consectetuer"));
        panelPricing.addItem(new Model_Data(false, "Adipiscing elit"));
        panelPricing.addItem(new Model_Data(false, "Sit amet"));
        panelPricing.addEventBuy(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                JOptionPane.showMessageDialog(Main.this, "Buy 1");
            }
        });
    }
